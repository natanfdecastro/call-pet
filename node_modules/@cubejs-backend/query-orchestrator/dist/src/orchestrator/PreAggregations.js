...
class PreAggregationLoadCache {
    ...
    async getVersionEntries(preAggregation) {
        ...
        if (!this.versionEntries[redisKey]) {
            const entries = tablesToVersionEntries(preAggregation.preAggregationsSchema, await this.getTablesQuery(preAggregation));
