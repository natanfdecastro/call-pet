...
declare type QueryWithParams = [string, any[]] | string;
declare type Query = {
    requestId?: string;
    dataSource: string;
};
...
export declare class QueryCache {
    ...
    private getRefreshKeyRenewalThresholds;
    ...
    static createQueue(redisPrefix: any, clientFactory: DriverFactory, executeFn: any, options: any): any;
