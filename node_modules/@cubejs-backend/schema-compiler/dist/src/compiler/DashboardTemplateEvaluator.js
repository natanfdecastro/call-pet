...
exports.DashboardTemplateEvaluator = void 0;
...
class DashboardTemplateEvaluator {
    ...
    compile(dashboardTemplates, errorReporter) {
        return dashboardTemplates.forEach((template) => this.validateAndCompile(template, errorReporter.inContext(`${template.name} dashboard template`)));
    }
...
exports.DashboardTemplateEvaluator = DashboardTemplateEvaluator;
//# sourceMappingURL=DashboardTemplateEvaluator.js.map