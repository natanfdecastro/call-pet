...
class DataSchemaCompiler {
    ...
    async compileCubeFiles(compilers, toCompile, errorsReport) {
        ...
        toCompile
            .forEach((file) => {
            this.compileFile(file, errorsReport, cubes, exports, contexts, dashboardTemplates, toCompile, compiledFiles, asyncModules);
        });
    ...
    compileFile(file, errorsReport, cubes, exports, contexts, dashboardTemplates, toCompile, compiledFiles, asyncModules) {
        const self = this;
        ...
        try {
            vm_1.default.runInNewContext(file.content, {
                ...
                dashboardTemplate: (name, template) => dashboardTemplates.push(Object.assign({}, template, { name, fileName: file.fileName })),
                addExport: (obj) => {
                ...
                require: (extensionName) => {
                    if (self.extensions[extensionName]) {
                        ...
                        self.compileFile(foundFile, errorsReport, cubes, exports, contexts, dashboardTemplates, toCompile, compiledFiles);
