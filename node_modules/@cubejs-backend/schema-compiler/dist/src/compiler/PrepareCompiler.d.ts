...
export declare const prepareCompiler: (repo: any, options: any) => {
    compiler: DataSchemaCompiler;
    metaTransformer: CubeToMetaTransformer;
    cubeEvaluator: CubeEvaluator;
    contextEvaluator: ContextEvaluator;
    dashboardTemplateEvaluator: DashboardTemplateEvaluator;
    joinGraph: JoinGraph;
    compilerCache: CompilerCache;
    headCommitId: any;
};
export declare const compile: (repo: any, options: any) => any;
