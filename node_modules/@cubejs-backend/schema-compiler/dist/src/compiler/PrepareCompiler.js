...
const DashboardTemplateEvaluator_1 = require("./DashboardTemplateEvaluator");
...
const prepareCompiler = (repo, options) => {
    ...
    const dashboardTemplateEvaluator = new DashboardTemplateEvaluator_1.DashboardTemplateEvaluator(cubeEvaluator);
