...
.ant-checkbox-disabled.ant-checkbox-checked .ant-checkbox-inner::after {
  border-color: rgba(20, 20, 70, 0.25);
...
.ant-checkbox-indeterminate.ant-checkbox-disabled .ant-checkbox-inner::after {
  background-color: rgba(20, 20, 70, 0.25);
  border-color: rgba(20, 20, 70, 0.25);
}
.ant-checkbox-rtl {
  direction: rtl;
...
.ant-menu-submenu-disabled {
  color: rgba(20, 20, 70, 0.25) !important;
  background: none;
  border-color: transparent !important;
  cursor: not-allowed;
}
...
.ant-menu-submenu-disabled > .ant-menu-submenu-title > .ant-menu-submenu-arrow::after {
  background: rgba(20, 20, 70, 0.25) !important;
}
...
.ant-slider-disabled .ant-slider-track {
  background-color: rgba(20, 20, 70, 0.25) !important;
}
.ant-slider-disabled .ant-slider-handle,
.ant-slider-disabled .ant-slider-dot {
  background-color: #fff;
  border-color: rgba(20, 20, 70, 0.25) !important;
  box-shadow: none;
  cursor: not-allowed;
}
...
.ant-steps-item-icon {
  ...
  line-height: 32px;
  text-align: center;
  border: 1px solid rgba(20, 20, 70, 0.25);
  border-radius: 32px;
...
.ant-switch:focus {
  outline: 0;
  box-shadow: 0 0 0 2px rgba(20, 20, 70, 0.1);
}
...
.ant-tabs-right > div > .ant-tabs-nav .ant-tabs-tab-active .ant-tabs-tab-btn {
  font-weight: normal;
  text-shadow: 0 0 0.25px rgba(122, 119, 255, 0.3);
}
